        ...
        <Container fluid className="mt-auto footer">
            <Row md={5}>
                <Col sm={12} md={5} id="col">
                    ...
                    <div id="epStatement">Dedicated to building Fitness lifestyles and realizing your physical potential alongside confidence in the mirror and self-love.</div>
                    <a href="https://www.tiktok.com/@nickjungrobinson" className="socialMediaIcons">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#6EC9BE" className="bi bi-tiktok" viewBox="0 0 16 16">
                            <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z"/>
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/nickjungrobinson/?hl=en" className="socialMediaIcons">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#6EC9BE" className="bi bi-instagram" viewBox="0 0 16 16">
                ...
                <Col sm={12} className="flex-grow-1" id="smallCol">
                    ...
                    <img
                        ...
                        width="80%"
                    />
                    <Nav.Link href="/contact" id="inquire">
